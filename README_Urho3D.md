...
[![Join the chat at https://gitter.im/urho3d/Craft](https://badges.gitter.im/urho3d/Craft.svg)](https://gitter.im/urho3d/Craft?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)

**Craft** is a free lightweight, cross-platform 2D and 3D game engine implemented in C++ and released under the MIT license. Greatly inspired by OGRE and Horde3D.

Main website: [https://urho3d.github.io/](https://urho3d.github.io/)

## License
Licensed under the MIT license, see [LICENSE](https://github.com/urho3d/Craft/blob/master/LICENSE) for details.
...
## Credits
Craft development, contributions and bugfixes by:
- Lasse Öörni
- Wei Tjong Yao
- Aster Jian
- Ricardo Abreu
...
Craft is greatly inspired by OGRE (http://www.ogre3d.org) and Horde3D
...
Craft uses the following third-party libraries:
...
License / copyright information included with the assets as necessary. All other assets (including shaders) by Craft authors and licensed similarly as the engine itself.

## Documentation
Craft classes have been sparsely documented using Doxygen notation. To
...
Documentation on how to build Craft:
  https://urho3d.github.io/documentation/HEAD/_building.html
Documentation on how to use Craft as external library
